...
def run_experiment(experiment_detals, experiment, timing_key, verbose, timings):
    ...
    for details in experiment_detals:
        logger.info("Running {} experiment: {}".format(
            timing_key, details.ds_readable_name))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--seed', type=int,
                        help='A random seed to set, if desired')
    ...
    parser.add_argument('--verbose', action='store_true',
                        help='If true, provide verbose output')
    ...
    datasets = [
        ...
        #{
        #    'data': loader.OcrDigitData(verbose=verbose, seed=seed),
        #    'name': 'ocr_digit',
        #    'readable_name': 'OCR Digit',
        #}
        # {
