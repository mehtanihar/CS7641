...
TEST_CREDIT = 'data/{}_test.csv'.format('CreditDefaultData')
TRAIN_CREDIT = 'data/{}_train.csv'.format('CreditDefaultData')
VALIDATE_CREDIT = 'data/{}_validate.csv'.format('CreditDefaultData')

TEST_OCR = 'data/{}_test.csv'.format('OcrDigitData')
TRAIN_OCR = 'data/{}_train.csv'.format('OcrDigitData')
VALIDATE_OCR = 'data/{}_validate.csv'.format('OcrDigitData')
...
experiment_data = [
    ...
    ([63, 128,128,128, 1], 5001, TEST_OCR, TRAIN_OCR, VALIDATE_OCR, "OcrDigitData"),
    #([23, 11,11,11,1], 5001, TEST_CREDIT, TRAIN_CREDIT, VALIDATE_CREDIT, "CreditDefaultData"),
    ]
